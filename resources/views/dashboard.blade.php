...
<div class="m-4 p-4">
<div class='flex sm:flex-row flex-col space-y-2 sm:space-x-2 flex-row w-full items-start justify-center min-h-screen'>
	...
	<div
		class='flex flex-wrap flex-row sm:flex-col justify-center items-center w-full sm:w-1/4 p-5 bg-white rounded-md shadow-xl border-l-4 border-yellow-300'>
		<div class="flex justify-between w-full">
			<div>
				<div class="p-2">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
		...
		<div >
			<div class="font-bold text-5xl text-center text-blue-600">
				1
			</div>
			<div class="font-bold text-sm text-blue-600">
				In Progess
